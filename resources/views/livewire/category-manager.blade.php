<div>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50 border-b border-gray-50 transition-colors">
                        ...
                        <td class="p-4 text-right">
                            <button wire:click="edit({{ $category->id }})" class="text-indigo-600 hover:text-indigo-900 mr-4 font-medium transition-colors">Edit</button>
                            <button wire:click="delete({{ $category->id }})" class="text-red-500 hover:text-red-700 font-medium transition-colors">Hapus</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="3" class="p-8 text-center text-gray-400">Belum ada data kategori.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto">
        ...
        <!-- Modal Content -->
        <div class="relative w-full max-w-md mx-auto z-50 animate-in fade-in zoom-in duration-200">
                ...
                <div class="px-6 py-4">
                    <form wire:submit.prevent="store">
                        <div class="mb-4">
                            ...
                            <input wire:model="name" type="text" id="name" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow" placeholder="Contoh: Hardware, Software">
